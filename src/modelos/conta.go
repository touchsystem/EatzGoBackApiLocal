...
// Conta representa a estrutura de uma conta em uma mesa
type Conta struct {
	...
	Vendas         []ContaVenda `json:"vendas,omitempty"` // Agora está correto
}

// ContaVenda representa os itens da conta
